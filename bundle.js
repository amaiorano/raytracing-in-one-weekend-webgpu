...
var Renderer = /*#__PURE__*/function () {
  ...
  _createClass(Renderer, [{
    ...
    value: function createScene1() {
      ...
      var lookfrom = fromValues(3, 3, 2);
      var lookat = fromValues(0, 0, -1);
      var delta = create();
      sub(delta, lookat, lookfrom);
      var focus_dist = vec3_length(delta);
      this.cameraCreateParams = new CameraCreateParams().lookfrom(lookfrom).lookat(lookat).vup(fromValues(0, 1, 0)).focus_dist(focus_dist).aperture(2.0).vfov(20.0).aspect_ratio(this.canvas.width / this.canvas.height);
    }
  }, {
    key: "updatePipeline",
